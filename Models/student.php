    ...
    <div class="container">
        <div class="row">
            ...
            <img src="bracu.png" class="img-thumbnail" alt="Cinque Terre">
                <h1 class="display-6 text-center">Mini Usis NETWORK (MUN)</h1>
            </div>
        </div>
        <div class="container">
            <div class="col-lg-12">
                ...
                <br>
                <a href = "../views/home.php"> <button type="button" class="btn btn-dark">Home</button></a>
...
?>
                    <tr class="text-center">
                        ...
                        <td> <button class="btn-warning btn"> <a href="../controller/update.php ?id=<?php echo $res['student_ID']; ?>" class="text-dark">
                                    Update </a> </button> </td>
                        <td> <button class="btn-danger btn"> <a href="../controller/delete.php ?id=<?php echo $res['student_ID']; ?>" class="text-dark">
                                    Delete </a> </button> </td>
